...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$260000$Ve3ifaI3eNElP8NrTUh0bF$LWiLIshlX4KvOwOVEbqdy8Q79dP36XxBK4WaI7sdAvY=','2021-10-08 23:24:10.405372',1,'admin','','','admin@gmail.com',1,1,'2021-10-08 23:24:00.261970');
...
INSERT INTO `course` VALUES (101,'Yoga','relaxes your mind'),(102,'Aerobics','Increase your stamina, fitness and strength'),(103,'zumba','Helps you de-stress');
...
INSERT INTO `django_admin_log` VALUES (1,'2021-10-08 23:29:13.026587','101','Course object (101)',1,'[{\"added\": {}}]',8,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(8,'fitnessadmin','course'),(7,'fitnessadmin','instructor'),(9,'fitnessadmin','session'),(10,'fitnessadmin','student'),(6,'sessions','session');
...
INSERT INTO `django_session` VALUES ('xt7ke92dfxqx9dbi82l4v7e0sdps03dn','.eJxVjMsOwiAQRf-FtSEUlIdL9_0GMjAzUjWQlHZl_HfbpAvd3nPOfYsI61Li2mmOE4qrGMTpd0uQn1R3gA-o9yZzq8s8Jbkr8qBdjg3pdTvcv4MCvWw1O3QMwToyRrHXHjWjPWu2IQefyaLZDO00qKAyMBBSyCbhJSUzOBafL_myON4:1mYzDm:EkDYprap45H2Nf4stGVNFl3l64FLIQgCwvDeYckRhqY','2021-10-22 23:24:10.415754');
...
CREATE TABLE `enroll` (
  ...
  CONSTRAINT `sessionId` FOREIGN KEY (`sessionId`) REFERENCES `session` (`sessionId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `enroll` VALUES (201,401),(202,401);
...
INSERT INTO `instructor` VALUES (301,'Christine Lewis','Yoga at the Desk Wellness Workshop','Welness','902-620-4844','wenmarbyoga@gmail.com'),(302,'Matthew Perry','Aerobics instructor','Aerobics','902-720-5467','matt@gmail.com'),(303,'Jhon Gonzalez','Zumba Instructor','Zumba','902-720-5674','jhong@gmail.com');
...
INSERT INTO `session` VALUES (401,301,101,'https://zoom.us/'),(402,302,102,'https://zoom.us/');
...
INSERT INTO `student` VALUES (201,'Student1','902-719-9999','S','student1@gmail.com','san123'),(202,'Student2','902-719-8889','Y','student2@gmail.com','pan123'),(203,'Student3','9027199090','R','student3@gmail.com','12345');
...
-- Dump completed on 2021-11-03 23:32:42
